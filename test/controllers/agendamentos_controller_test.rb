...
class AgendamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agendamento" do
    assert_difference("Agendamento.count") do
      post agendamentos_url, params: { agendamento: { fimAtendimento: @agendamento.fimAtendimento, inicioAtendimento: @agendamento.inicioAtendimento } }
    end
  ...
  test "should update agendamento" do
    patch agendamento_url(@agendamento), params: { agendamento: { fimAtendimento: @agendamento.fimAtendimento, inicioAtendimento: @agendamento.inicioAtendimento } }
